...
import logo from '/public/images/banter-logo.png'
import logoIcon from '/public/images/banter-icon-logo.png'
  ...
  return (
    <div className="flex shrink-0 items-center">
      <Link href="/" className="h-9 lg:hidden">
        <Image src={logoIcon} alt="Banter Logo Icon" className="h-auto w-9" />
      </Link>
      <Link href="/" className="hidden h-9 lg:block">
        <Image src={logo} alt="Banter logo" className="h-9 w-auto" />
      </Link>
    </div>
  )
}
